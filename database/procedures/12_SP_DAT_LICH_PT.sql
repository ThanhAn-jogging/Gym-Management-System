CREATE OR REPLACE PROCEDURE SP_DAT_LICH_PT (
    ...
    v_NewMaLich VARCHAR2(10); -- Biến tự sinh mã LT00x
    v_CountPT NUMBER;
    v_CountHV NUMBER;
    v_CountLop NUMBER;
    ...
    v_ThuVN VARCHAR2(20);
BEGIN
    -- 1. TỰ SINH MÃ THEO PHONG CÁCH "LT001", "LT002" TỪ SEQUENCE
    v_NewMaLich := 'LT' || LPAD(SEQ_LICHTAP_PT.NEXTVAL, 3, '0');

    -- Phân tích Thứ trong tuần từ ngày chọn
    ...
    -- CHỐT 1: Kiểm tra trùng Lớp học của PT
    ...
    -- CHỐT 2: Kiểm tra trùng lịch PT cá nhân khác của PT
    ...
    -- CHỐT 3: Kiểm tra trùng lịch của Hội viên
    ...
    -- INSERT DỮ LIỆU VỚI MÃ CHUỖI VỪA SINH
